...
class ScansionConstants:
    ...
    def CheckDoubleConsonant(self, string):
        string = "apa"
        x = re.match("/^[aeiou]/", string)
        print('1', x)
    ...
    def __init__(self, unstressed="U", stressed="-", optional_terminal_ending="X", separator="|"):
        ...
        self.EXCEPTIONS = { "cui": ["cui"], "Cui": ["Cui"], "hui": ["hui"], "Hui": ["Hui"], "huic": ["huic"],
                               ...
                               # as a dipthong, which is otherwise never is,
                               # except in Greek names
                               "Seu": ["Seu"],"neu": ["neu"], "Neu": ["Neu"],
                               "ceu": ["neu"], "Ceu": ["Neu"],
                               "heu": ["heu"], "Heu": ["Heu"],}
        ...
        self.LIQUIDS = "lrLR"
        self.NASALS = "mnMN"
        self.FRICATIVES = "fsFS"
        self.CLUSTERABLE = 'lLrRsSwW'
        #self.MUTES = "bcdfgptBCDFGPT"
        self.MUTES = "bcdgptkKBCDGPT"
        ...
        self.PREFIXES = ['praeter', 'contrā', 'contra', 'subter', 'circum', 'trans', 'extro', 'suprā', 'extrā',
                         ...
                         'kwadri', 'kwadra',
                         'ante', 'ambi', 'tran', 'dein', 'prae', 'post', 'kwid', 'sine', 'sed', 'pre',
